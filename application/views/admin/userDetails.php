 ...
 <div class="col-md-12">
    <div class="card-body">
        <div class="row show-grid ">
            <div class="col-md-12 bg-secondary text-center"><strong><h4>Details of User</h4></strong></div>
        </div>
        <div class="row show-grid">
        ...
        <div class="row show-grid">
            ...
            <div class="col-md-9 "><p><?php echo $user['mobile'] ?></p></div>
        </div>
        <div class="row show-grid">
        ...
        <div class="row show-grid">
            ...
            <div class="col-md-9 "><?php echo date("d/m/Y",$user['creation_date']) ?></div>
        </div>          
    </div>
 </div>
...
var userid = "<?php echo base64_encode($user['userid']) ?>";
...
function ajaxgetTable(status){
  $.ajax({
		type: "POST",
		url: baseurl + "admin/admin/userbasedcomplaintlist",
		data: {'user':userid,'status':status},
		dataType: "JSON",
